...
var Terminal =
  ...
  function (cmdLineContainer, outputContainer) {
    ...
    var age = Math.trunc(
      (current_date - birth_date) / (3600 * 24 * 365 * 1000)
    );
