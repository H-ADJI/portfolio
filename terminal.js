...
var Terminal = Terminal || function (cmdLineContainer, outputContainer) {
  ...
  return {
    init: function () {
      output('<h1>HADJI KHALIL, (I USE GNU/LINUX BTW)</h1><h3>Software engineer who likes to automate stuff and to dribble around with data.<h3><p>Enter "help" for more information.</p><p> --</p>');
    },
    output: output
  }
};
